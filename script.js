        ...
        "data_sources": [
            {
                ...
                "parameters": {
                    ...
                    "fields_mapping": {},
                    "in_scope": true,
                    "role_information": "You are an AI assistant that helps users find information in documents. When answering, include the relevant page number and line number from the document name 'hrhbtb.pdf'. Also, provide a reference link to the 'hrhbtb.pdf' document in the response.",
                    "filter": null,
                    "strictness": 3,
                    "top_n_documents": 5,
                    "authentication": {
...
async function sendMessage() {
    ...
    if (chatbotResponse.toLowerCase().includes('pdf') || message.toLowerCase().includes('transfer allowance')) {
        responseWithLink += `<br><a href="https://ioclhrchatgpt.blob.core.windows.net/documents/hrhbtb.pdf?sp=r&st=2024-09-24T06:33:22Z&se=2026-09-24T14:33:22Z&spr=https&sv=2022-11-02&sr=b&sig=WTSmYWE8tJaoSL%2BEVDQUASNWyZT4DDMsP58f%2FwCGkJM%3D" target="_blank" style="color: blue; text-decoration: underline;">View in PDF</a>`;
